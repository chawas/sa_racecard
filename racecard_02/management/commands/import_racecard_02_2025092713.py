...
class Command(BaseCommand):
        ...
        try:
            if filename:
                ...
                if calculate_rankings and races:
                    for race in races:
                        self._calculate_horse_scores(race)  # This now uses services
    ...
    def _process_single_file(self, file_path, update_existing):
        ...
        try:
            ...
            # Calculate scores after all data is imported (NOW USING SERVICES)
            for race in races:
    ...
    def _display_calculated_scores(self, race, horse_scores, magic_tips):
        """Display calculated scores without database ranking"""
        ...
        for rank, score in enumerate(sorted_scores, 1):
            ...
            self.stdout.write(f"{rank:2d}    {score.horse.horse_no:2d}      {score.horse.horse_name:<18}  {score.overall_score:5.1f}  {star}")
...
# Keep your existing methods that weren't modified