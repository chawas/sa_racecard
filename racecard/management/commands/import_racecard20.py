...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Determine whether it's a directory or a single file
        ...
        for file_path in html_files:
            ...
            # Extract distance and merit/class
            ...
            self.stdout.write(f"📅 Date: {race_date}, 🕒 Time: {race_time}, 🏁 No: {race_no}")
            ...
            race, created = Race.objects.get_or_create(
                ...
                race_field=field,
                defaults={
                    "race_time": int(re.sub(r"\D", "", race_time)),
                    "race_name": race_name,
            ...
            for row in rows:
                ...
                if not horse_number.isdigit():
                    continue  # Skip rows like headers or bad rows
                ...
                self.stdout.write(f"✅ Horse {horse.horse_no}: {horse.horse_name} (MR: {horse_merit}, Odds: {odds})")
